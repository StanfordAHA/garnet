...
echo "INFO $0 starting here: `pwd`"; echo ""
...
echo "INFO"; echo "INFO Remove PE module from unified verilog 'garnet.sv'"
set echo
./cutmodule.awk PE \
  < genesis_verif/garnet.sv \
  > genesis_verif/garnet.no_pe.sv \
