...
create_generated_clock -add -name clk_out -master_clock clk -source [get_ports clk] -multiply_by 1 [get_pins */clk_out]
#create_clock -name tck -period 50 -waveform {0 25} [get_ports pad_tck]
...
#set_multicycle_path -setup 2 -from */read_config_data[0] -to global_controller/config_data_jtag_in_reg*
#set_multicycle_path -hold 1 -from */read_config_data[0] -to global_controller/config_data_jtag_in_reg* 
