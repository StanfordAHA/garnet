...
create_power_domain AON -elements { DECODE_FEATURE_13 coreir_eq_16_inst0 and_inst1 FEATURE_AND_13 PowerDomainConfigReg_inst0}
...
set_related_supply_net -object_list {clk reset config_config_addr config_config_data config_read config_write read_config_data_in stall} -power VDD -ground VSS
