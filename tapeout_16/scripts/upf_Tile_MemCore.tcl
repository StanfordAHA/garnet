...
set_related_supply_net -object_list {tile_id clk reset config_config_addr config_config_data config_read config_write read_config_data_in stall} -power VDD -ground VSS
