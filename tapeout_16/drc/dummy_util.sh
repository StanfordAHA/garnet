...
d="/home/kongty/new_runsets/dummies"
...
calibre -drc -hier -turbo -hyper -64 dummy_feol.drc | tee feol_dummy_util.log | grep -P '^ERROR|^DRC RuleCheck'
...
calibre -drc -hier -turbo -hyper -64 dummy_beol.drc | tee beol_dummy_util.log | grep -P '^ERROR|^DRC RuleCheck'

echo "Merging dummy metal gds with original gds"
mgds=${toplevel}_with_dummy.gds
