...
class GlbLoadDma(Generator):
    def __init__(self, _params: GlobalBufferParams):
        ...
        # Should hold for both onyx and amber
        ...
        # Amber cfg_dma_header_t == cfg_load_dma_header_t == cfg_store_dma_header_t, see glb_header.py
        ...
        # AMBER loop_level == load_dma_loop_level
