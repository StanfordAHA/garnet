...
class GlbCoreStrmMux(Generator):
    def __init__(self, _params: GlobalBufferParams):
        ...
        # local variables
        self.data_g2f_int = self.var("data_g2f_int", width=self._params.cgra_data_width,
                                     size=self._params.cgra_per_glb, packed=True)
        self.data_valid_g2f_int = self.var("data_valid_g2f_int", 1, size=self._params.cgra_per_glb, packed=True)
