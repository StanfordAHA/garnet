...
class GlbTile(Generator):
    def __init__(self, _params: GlobalBufferParams):
        ...
        self.cgra_cfg_pcfg_wr_en_wsti = self.input("cgra_cfg_pcfg_wr_en_wsti", 1)
        self.cgra_cfg_pcfg_rd_en_wsti = self.input("cgra_cfg_pcfg_rd_en_wsti", 1)
        self.cgra_cfg_pcfg_addr_wsti = self.input("cgra_cfg_pcfg_addr_wsti", self._params.cgra_cfg_addr_width)
        self.cgra_cfg_pcfg_data_wsti = self.input("cgra_cfg_pcfg_data_wsti", self._params.cgra_cfg_data_width)
        self.cgra_cfg_pcfg_wr_en_esto = self.output("cgra_cfg_pcfg_wr_en_esto", 1)
        self.cgra_cfg_pcfg_rd_en_esto = self.output("cgra_cfg_pcfg_rd_en_esto", 1)
        self.cgra_cfg_pcfg_addr_esto = self.output("cgra_cfg_pcfg_addr_esto", self._params.cgra_cfg_addr_width)
        self.cgra_cfg_pcfg_data_esto = self.output("cgra_cfg_pcfg_data_esto", self._params.cgra_cfg_data_width)

        self.cgra_cfg_pcfg_wr_en_esti = self.input("cgra_cfg_pcfg_wr_en_esti", 1)
        self.cgra_cfg_pcfg_rd_en_esti = self.input("cgra_cfg_pcfg_rd_en_esti", 1)
        self.cgra_cfg_pcfg_addr_esti = self.input("cgra_cfg_pcfg_addr_esti", self._params.cgra_cfg_addr_width)
        self.cgra_cfg_pcfg_data_esti = self.input("cgra_cfg_pcfg_data_esti", self._params.cgra_cfg_data_width)
        self.cgra_cfg_pcfg_wr_en_wsto = self.output("cgra_cfg_pcfg_wr_en_wsto", 1)
        self.cgra_cfg_pcfg_rd_en_wsto = self.output("cgra_cfg_pcfg_rd_en_wsto", 1)
        self.cgra_cfg_pcfg_addr_wsto = self.output("cgra_cfg_pcfg_addr_wsto", self._params.cgra_cfg_addr_width)
        self.cgra_cfg_pcfg_data_wsto = self.output("cgra_cfg_pcfg_data_wsto", self._params.cgra_cfg_data_width)
    ...
    def pcfg_wiring(self):
        ...
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsti['wr_en'], self.cgra_cfg_pcfg_wr_en_wsti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsti['rd_en'], self.cgra_cfg_pcfg_rd_en_wsti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsti['addr'], self.cgra_cfg_pcfg_addr_wsti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsti['data'], self.cgra_cfg_pcfg_data_wsti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esto['wr_en'], self.cgra_cfg_pcfg_wr_en_esto)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esto['rd_en'], self.cgra_cfg_pcfg_rd_en_esto)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esto['addr'], self.cgra_cfg_pcfg_addr_esto)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esto['data'], self.cgra_cfg_pcfg_data_esto)

        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esti['wr_en'], self.cgra_cfg_pcfg_wr_en_esti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esti['rd_en'], self.cgra_cfg_pcfg_rd_en_esti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esti['addr'], self.cgra_cfg_pcfg_addr_esti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_esti['data'], self.cgra_cfg_pcfg_data_esti)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsto['wr_en'], self.cgra_cfg_pcfg_wr_en_wsto)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsto['rd_en'], self.cgra_cfg_pcfg_rd_en_wsto)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsto['addr'], self.cgra_cfg_pcfg_addr_wsto)
        self.wire(self.glb_pcfg_broadcast.cgra_cfg_pcfg_wsto['data'], self.cgra_cfg_pcfg_data_wsto)
