...
class GlobalBuffer(Generator):
    def __init__(self, num_banks, num_io, num_cfg, \
            bank_addr, top_cfg_addr=12, cfg_addr=32, cfg_data=32):
        super().__init__()

        self.num_banks = num_banks
        self.bank_addr = bank_addr
        self.glb_addr = math.ceil(math.log2(self.num_banks))\
                + self.bank_addr
        self.num_io = num_io
        ...
        self.cgra_config_type = ConfigurationType(\
