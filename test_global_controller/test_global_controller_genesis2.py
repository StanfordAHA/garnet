...
global_controller(clk_in: In(Bit), reset_in: In(Bit), config_data_in: Array(32,In(Bit)), config_addr_out: Array(32,Out(Bit)), config_data_out: Array(32,Out(Bit)), clk_out: Out(Bit), reset_out: Out(Bit), cgra_stalled: Array(4,Out(Bit)), read: Out(Bit), write: Out(Bit), tdi: In(Bit), tdo: Out(Bit), tms: In(Bit), tck: In(Bit), trst_n: In(Bit))
"""  # nopep8
