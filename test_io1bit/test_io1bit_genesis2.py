...
io1bit(clk: In(Bit), reset: In(Bit), pad: InOut(Bit), p2f: Out(Bit), f2p_16: In(Bit), f2p_1: In(Bit), config_addr: Array(32,In(Bit)), config_data: Array(32,In(Bit)), config_write: In(Bit), config_read: In(Bit), tile_id: Array(16,In(Bit)), read_data: Array(32,Out(Bit)))
"""  # nopep8
