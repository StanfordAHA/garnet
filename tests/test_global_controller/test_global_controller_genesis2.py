...
def test_global_controller_genesis2(capsys):
    ...
    assert out == f"""\
Running genesis cmd 'Genesis2.pl -parse -generate -top global_controller -input global_controller/genesis/global_controller.vp global_controller/genesis/jtag.svp global_controller/genesis/tap.svp global_controller/genesis/flop.svp global_controller/genesis/cfg_and_dbg.svp -parameter global_controller.cfg_bus_width='32' -parameter global_controller.cfg_addr_width='32' -parameter global_controller.cfg_op_width='5' -parameter global_controller.soc_addr='12''
