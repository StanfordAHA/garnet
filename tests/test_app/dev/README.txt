...
- "vfiles" subdirectory contains a cache of ealborated garnet verilog files; you may or may not want to replace them with the latest version of whatever you're testing
