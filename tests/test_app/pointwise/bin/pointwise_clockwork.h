#ifndef HALIDE_____bin___pointwise_clockwork_h
#define HALIDE_____bin___pointwise_clockwork_h
#include <stdint.h>
...
int pointwise_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *pointwise_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
