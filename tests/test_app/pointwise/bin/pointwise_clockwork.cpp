...
int pointwise_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 63, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 63, _97, _100);
   return _101;
  }
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"pointwise"}, 1};
  ...
  int32_t _265 = _halide_buffer_get_min(_output_buffer, 1);
  bool _266 = 0 <= _265;
  int32_t _267 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _268 = _267 + _265;
  bool _269 = _268 <= 64;
  bool _270 = _266 && _269;
  if (!_270)   {
   int32_t _271 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _272 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _273 = _272 + _271;
   int32_t _274 = _273 + -1;
   int32_t _275 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 63, _271, _274);
   return _275;
  }
  int32_t _276 = _halide_buffer_get_min(_output_buffer, 0);
  bool _277 = 0 <= _276;
  int32_t _278 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _279 = _278 + _276;
  bool _280 = _279 <= 64;
  bool _281 = _277 && _280;
  if (!_281)   {
   int32_t _282 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _283 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _284 = _283 + _282;
   int32_t _285 = _284 + -1;
   int32_t _286 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 63, _282, _285);
   return _286;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 64; _output_s0_y++)
  {
   ...
   {
    int32_t _287 = _output_s0_y * 64;
    int32_t _288 = _287 + _output_s0_x;
_288;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _289 = _hw_output_stencil_host[_288];
    uint8_t _290 = (uint8_t)(_289);
    int32_t _291 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _292 = _291 * _output_s0_y;
    int32_t _293 = _292 + _output_s0_x;
    ((uint8_t *)_output)[_293] = _290;
   } // for _output_s0_x
  } // for _output_s0_y
