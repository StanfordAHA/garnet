...
def test_interconnect_point_wise(batch_size: int):
    ...
    config_data.append(interconnect.get_route_bitstream(sb_data0,
                                                               port_data0))
    config_data.append(interconnect.get_route_bitstream(sb_data1,
                                                               port_data1))
    output_port = graph_16[1, 1].ports["res"]
    output_sb = graph_16[1, 1].get_sb(SwitchBoxSide.EAST,
                                      0,
                                      SwitchBoxIO.SB_OUT)
    config_data.append(interconnect.get_route_bitstream(output_port,
                                                               output_sb))
    ...
    for x in range(2, chip_size + 1):
        ...
        next_node = graph_16[x, 1].get_sb(SwitchBoxSide.EAST,
                                          0,
                                          SwitchBoxIO.SB_OUT)
        config = interconnect.get_route_bitstream(pre_node,
                                                         next_node)
...
def test_interconnect_line_buffer():
    ...
    config_data.append(interconnect.get_route_bitstream(input_node,
                                                               mem_in))
    ...
    config_data.append(interconnect.get_route_bitstream(mem_out,
                                                               next_node1))
    ...
    config_data.append(interconnect.get_route_bitstream(next_node0,
                                                               data0))
    next_node1 = graph16.get_sb(1, 1, SwitchBoxSide.EAST, 1, SwitchBoxIO.SB_IN)
    data1 = graph16.get_port(1, 1, "data1")
    config_data.append(interconnect.get_route_bitstream(next_node1,
                                                               data1))
    ...
    output_node = graph16.get_sb(1, 1, SwitchBoxSide.WEST, 0,
                                 SwitchBoxIO.SB_OUT)
    config_data.append(interconnect.get_route_bitstream(data_out,
                                                               output_node))
    ...
    config_data.append(interconnect.get_route_bitstream(wen_sb,
                                                               wen_port))
...
def test_interconnect_sram():
    ...
    config_data.append(interconnect.get_route_bitstream(ren_sb,
                                                               ren_port))
    sram_data = []
    # add SRAM data
