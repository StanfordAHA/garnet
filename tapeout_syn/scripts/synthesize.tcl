...
$::env(SAED32_PATH)/lib/stdcell_rvt/db_nldm/saed32rvt_tt1p05vn40c.db \
$::env(SAED32_PATH)/lib/stdcell_rvt/db_nldm/saed32rvt_dlvl_tt1p05vn40c_i1p05v.db \
$::env(SAED32_PATH)/lib/stdcell_rvt/db_nldm/saed32rvt_pg_tt1p05vn40c.db \
$::env(SAED32_PATH)/lib/stdcell_rvt/db_nldm/saed32rvt_ulvl_tt1p05vn40c_i1p05v.db]
...
#create_mw_lib -technology $::env(SAED32_28_PDK)/techfiles/saed32nm_1p9m_mw.tf \
#-mw_reference_library


set design_name $::env(DESIGN)

#set mw_design_library "./work_gemm"
