        ...
        if "is_ub" in instr and instr["is_ub"]:
            ...
            configs += [(self.get_reg_index("rate_matched"),
                        ...
                        (self.get_reg_index("range_5"),
                         instr["range_5"]),
                        (self.get_reg_index("valid_sched_0"),
                         instr["valid_sched_0"]),
                        (self.get_reg_index("valid_sched_1"),
                         instr["valid_sched_1"]),
                        (self.get_reg_index("valid_sched_2"),
                         instr["valid_sched_2"]),
                        (self.get_reg_index("valid_sched_3"),
                         instr["valid_sched_3"]),
                        (self.get_reg_index("valid_sched_4"),
                         instr["valid_sched_4"]),
                        (self.get_reg_index("valid_sched_5"),
                         instr["valid_sched_5"]),
