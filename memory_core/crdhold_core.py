...
class CrdHoldCore(LakeCoreBase):
    ...
    def __init__(self,
        ...
        crdholdcore_name = "CrdHoldCore"
        super().__init__(config_data_width=config_data_width,
                         config_addr_width=config_addr_width,
                         data_width=data_width,
                         name=crdholdcore_name,
                         ready_valid=True)
        ...
        if cache_key not in LakeCoreBase._circuit_cache:
            ...
            self.dut = CrdHold(data_width=self.data_width,
