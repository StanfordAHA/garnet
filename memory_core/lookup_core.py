...
class LookupCore(LakeCoreBase):
    ...
    def __init__(self,
        ...
        if cache_key not in LakeCoreBase._circuit_cache:
            ...
            self.dut = Lookup(data_width=data_width)
    ...
    def pnr_info(self):
        return PnRTag("L", self.DEFAULT_PRIORITY, 1)
