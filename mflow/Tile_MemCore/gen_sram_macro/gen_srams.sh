...
sram_name="ts1n16ffcllsblvtc${num_words}x${word_size}m${mux_size}sw_130a"
./mc/tsn16ffcllhdspsbsram_130a.pl -file config.txt -NonBIST -NonSLP -NonDSLP -NonSD

ln -s ../$sram_name/NLDM/${sram_name}_${corner}.lib outputs/sram.lib
