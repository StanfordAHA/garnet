...
def test_cb_genesis2(capsys):
    ...
    assert out == f"""\
Running genesis cmd 'Genesis2.pl -parse -generate -top cb -input cb/cb.vp -parameter cb.width='16' -parameter cb.num_tracks='10' -parameter cb.feedthrough_outputs='1111101111' -parameter cb.has_constant='1' -parameter cb.default_value='7''
