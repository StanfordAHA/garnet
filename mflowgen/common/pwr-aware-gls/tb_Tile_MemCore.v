module tb_Tile_MemCore();
  ...
  initial begin
      ...
      #1 $display("hi after tile is disabled = %h", hi);
      #1 $display("lo after tile is disabled = %h", lo);
      #1 config_write = 1;
      #1 config_read = 0;
      #1 stall = 0;
      ...
      #2 assert (clk_out == clk) $display ("PASS: Clk is ON");
         else $error("Clk is OFF"); 
      #1 assert (clk_pass_through_out == clk_pass_through) $display ("PASS: Clk Passthrough is ON");               
      ...
      #1 assert (dut.PowerDomainConfigReg_inst0.ps_en_out == 1'b0) $display ("ASSERTION 6 PASS: Tile is turned on again through config reg");
      ...
      // ======================================
      #1 $display("\n===================================");
      #1 $display("==== TEST 7 - AOI-CONST-MUX OUT CHECKS  ======");
      #1 $display("==================================="); 
      #1 config_config_addr = 32'h000F0000;
      ...
      #1 config_write = 1;
      //#1 $display("Sel = %d",dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.S);
      #1 $display("AOI-CONST MUX OUT = %h", dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.O);
      #1 $display("Inter AOI-CONST MUX OUT = %h", dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O0);
      #1 $display("\n===================================");
      #1 $display("ASSERTION #7");
      #1 assert (dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.O == 0) $display ("ASSERTION 6 PASS: Constant mux output generated when sel==height");
         else $error("ASSERTION 7 FAIL: AOI-Const Mux output incorrect when sel==height");
      #1 $display("ASSERTION #8");
      #1 assert (dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O0 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O1 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O2 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O3 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O4 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O5 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O6 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O7 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O8 == 0 && dut.CB_data_in.CB_data_in_mux_aoi_const_20_16_inst0.u_mux_logic.O9 == 0) $display ("ASSERTION 7 PASS: X Prop is terminated at 1st stage of MUX");
         else $error("ASSERTION 8 FAIL : X Prop is not terminated at 1st stage of MUX");
