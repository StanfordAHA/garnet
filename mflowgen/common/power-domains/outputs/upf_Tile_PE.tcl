...
create_power_domain AON -elements { PowerDomainOR DECODE_FEATURE_8 coreir_eq_16_inst0 and_inst1 FEATURE_AND_8 PowerDomainConfigReg_inst0 const_511_9 const_0_8}
...
set_related_supply_net -object_list {clk_out clk_pass_through_out_bot clk_pass_through_out_right reset_out config_out_config_addr config_out_config_data config_out_read config_out_write read_config_data stall_out} -power VDD -ground VSS
