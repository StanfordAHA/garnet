...
# main.tcl
#=========================================================================
# Check for the power domains clamping logic
#
...
if {[expr $non_ao_diode_cell_cnt > 0]} {
   echo "FAIL" > result
   echo "" >> result
   echo "Clamping logic structure" "in the SBs and CBs" "is not maintained" >> result
} else {
   echo "PASS" > result
   echo "" >> result
   echo "Clamping logic structure" "in the SBs and CBs" "is maintained" >> result
}

# Check the count of AO cells
puts "\n Non-AO cell count is:  " >> result
puts " $non_ao_diode_cell_cnt" >> result

# Check the count of diode cells
puts " Diode cell count is:  " >> result
puts " $diode_cell_cnt" >> result

# Check count of non-AO non-diode cells
puts " AO cell count is:  " >> result
puts " $ao_cell_cnt \n" >> result
