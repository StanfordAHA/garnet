...
set oas0    $env(input_oasis_parent)
set oas1    $env(input_oasis_child)
set oasout  $env(output_oasis)

set coord_x $env(child_oasis_loc_x)
set coord_y $env(child_oasis_loc_y)
