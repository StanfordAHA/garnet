...
def construct():
  ...
  # This script is used to report the timing of passthrough signals, not needed for matrix unit
  ...
  # These constraints are used to disable comb loops in PE/MEM tiles, not needed for matrix unit
  ...
  # Outputs
  g.add_output( 'ProcessingElement-typical.lib',    genlibdb_tt.o('design.lib')       )
  g.add_output( 'ProcessingElement-typical.db',     genlibdb_tt.o('design.db')        )
  g.add_output( 'ProcessingElement-bc.lib',         genlibdb_ff.o('design.lib')       )
  g.add_output( 'ProcessingElement-bc.db',          genlibdb_ff.o('design.db')        )
  g.add_output( 'ProcessingElement.lef',            signoff.o('design.lef')           )
  g.add_output( 'ProcessingElement.oas',            signoff.o('design-merged.oas')    )
  g.add_output( 'ProcessingElement.sdf',            signoff.o('design.sdf')           )
