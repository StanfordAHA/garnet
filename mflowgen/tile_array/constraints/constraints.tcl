...
set_multicycle_path -setup 6 -from [get_ports reset]
set_multicycle_path -hold 5 -from [get_ports reset]
set_multicycle_path -setup 6 -from [get_ports stall*]
set_multicycle_path -hold 5 -from [get_ports stall*]
}
...
set_multicycle_path 16 -to [get_ports read_config_data] -setup
set_multicycle_path 15 -to [get_ports read_config_data] -hold
