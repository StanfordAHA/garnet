...
foreach layer { m3 m4 m5 m6 m7 m8 } {
    ...
    if { $layer == "m3" || $layer == "m5" || $layer == "m7" } {
        set stripe_direction vertical
    } else {
        set stripe_direction horizontal
    }
    # determine if stripes will extend to the design boundary
    if { $layer == "m5" || $layer == "m6" || $layer == "m7" || $layer == "m8" } {
        set extend_target design_boundary
    } else {
        set extend_target all_domains
    }
