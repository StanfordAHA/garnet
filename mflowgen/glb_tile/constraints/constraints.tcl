...
# TODO: these output ports should have longer delay
# 1. connected to cgra
...
set_false_path -through [get_cells -hier glb_pio] -through [get_ports glb_tile_int/glb_tile_cfg/cfg_* -filter "direction==out"]
