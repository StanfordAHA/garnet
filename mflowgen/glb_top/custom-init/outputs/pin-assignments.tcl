...
set top [sort_collection [get_ports proc2glb_*] hierarchical_name]
set bottom [get_ports -filter {hierarchical_name !~ proc2glb_* && hierarchical_name !~ clk* && hierarchical_name !~ reset && hierarchical_name !~ glb_cfg_* && hierarchical_name !~ sram_cfg_* && hierarchical_name !~ cgra_cfg_gc2glb* && hierarchical_name !~ *pulse*}]
...
editPin -pin [get_property $top  hierarchical_name] -start [list 5 0] -end [list [expr {$width - 5}] 0] -side TOP -spreadType RANGE -spreadDirection clockwise -layer M5
