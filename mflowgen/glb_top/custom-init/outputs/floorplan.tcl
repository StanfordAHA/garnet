...
# set tile_width_offset [expr 20 * $horiz_pitch]
set tile_width_offset 0
...
set core_width [expr ($num_tiles * $tile_width) + (($num_tiles - 1) * $tile_width_offset) + $tile_margin_l + $tile_margin_r]
...
foreach_in_collection tile $tiles {
  ...
  set x_loc [expr $x_loc + $tile_width + $tile_width_offset]
}
