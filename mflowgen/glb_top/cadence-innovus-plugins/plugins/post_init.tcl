...
set macro_paths [dbGet [dbGet top.insts.cell.name glb* -p2].name]

# Group paths to/from macros
group_path -name All2Macro -to   $macro_paths
group_path -name Macro2All -from $macro_paths

# Prioritize timing to macros
foreach group {All2Macro Macro2All} {
