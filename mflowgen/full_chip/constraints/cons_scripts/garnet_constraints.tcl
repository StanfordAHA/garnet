...
#set_multicycle_path 3 -setup -to [get_pins -hier *global_controller*/glb_cfg_rd_data*]
#set_multicycle_path 2 -hold -to [get_pins -hier *global_controller*/glb_cfg_rd_data*]
