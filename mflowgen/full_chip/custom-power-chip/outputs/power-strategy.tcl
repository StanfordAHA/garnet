...
# Oops! vertical gmb stripes are creating weird shape of gv0 at the top
# edge to connect to lower gm0
# create via blockage to prevent this
set gv0_block_llx  540.0
set gv0_block_lly 3225.0
set gv0_block_urx 3380.0
set gv0_block_ury 3235.0
createRouteBlk \
    -name RDL_BLOCKAGE_TEMP \
    -cutLayer gv0 \
    -box "$gv0_block_llx $gv0_block_lly $gv0_block_urx $gv0_block_ury"
...
editAddRoute 817.583 72.000
editCommitRoute 817.583 72.000
setEditMode -create_crossover_vias 1
editAddRoute 815.881 72.000
