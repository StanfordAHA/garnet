...
# 12/2022 Got a M3 short at 400u x spacing, changed to 1200u to fix it
set sram_spacing_y      [expr 100 * $vert_pitch]
set sram_spacing_x_odd  [expr 1200 * $horiz_pitch]
set sram_spacing_x_even [expr 1200 * $horiz_pitch]
