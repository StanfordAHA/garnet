...
# set core_width  [expr 246 * $tech_pitch_x - $core_margin_left - $core_margin_right]
# set core_height [expr 200 * $tech_pitch_y - $core_margin_top - $core_margin_bottom]
set core_width  [expr 232 * $tech_pitch_x - $core_margin_left - $core_margin_right]
set core_height [expr 214 * $tech_pitch_y - $core_margin_top - $core_margin_bottom]
#-------------------------------------------------------------------------
# Floorplan
#-------------------------------------------------------------------------
